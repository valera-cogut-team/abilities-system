...
namespace Audio.Application
{
    public sealed class AudioService : IAudioService
    {
        ...
        private void EnsureHost()
        {
            ...
            _host = new GameObject(AudioConstants.HostObjectName);
            ...
            var sfxGo = new GameObject(AudioConstants.SfxSourceObjectName);
        ...
        public void PlaySound2D(AudioClip clip, float volumeScale = 1f)
        {
            if (clip == null)
                return;
            EnsureHost();
            float v = (_muted ? 0f : _master * _sfxVolume) * Mathf.Clamp01(volumeScale);
            if (v > AudioConstants.VolumeEpsilon)
