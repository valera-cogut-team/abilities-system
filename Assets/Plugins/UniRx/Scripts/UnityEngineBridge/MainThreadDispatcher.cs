...
#pragma warning restore CS0618
        ...
        public static void Initialize()
        {
            if (!initialized)
            {
                ...
                try
                {
                    dispatcher = UnityEngine.Object.FindFirstObjectByType<MainThreadDispatcher>();
                }
                catch
                {
        ...
        {
            var dispatchers = UnityEngine.Object.FindObjectsByType<MainThreadDispatcher>(FindObjectsSortMode.None);
        ...
        void OnDestroy()
        {
            if (instance == this)
            {
                instance = UnityEngine.Object.FindFirstObjectByType<MainThreadDispatcher>();
